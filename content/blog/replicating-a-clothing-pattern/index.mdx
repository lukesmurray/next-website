...
```js
{
  ...
  return svg`<svg width="${width}" height="${height}">
<defs>
    <pattern id="outlineMaskCircles" x="${size /
      2}" y="0" width="${size}" height="${size}" patternUnits="userSpaceOnUse">
...
<iframe width="100%" height="885" frameborder="0" title="Svg Spirals"
  src="https://observablehq.com/embed/@lukesmurray/svg-spirals?cell=circles&cell=viewof+squareSize&cell=viewof+circleSize&cell=viewof+innerCircleSize&cell=viewof+gap&cell=viewof+color1&cell=viewof+color2"></iframe>