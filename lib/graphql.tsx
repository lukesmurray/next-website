...
export type SlugPageQuery = { root?: Maybe<{ slug: string, title: string }>, currentPage?: Maybe<{ slug: string, title: string, html: string, pages: Array<{ slug: string, title: string }> }> };
